...
public class MinimumNumberOfArrowsToBurstBalloons {
    public int findMinArrowShots(int[][] points) {
        ...
        Arrays.sort(points, Comparator.comparingInt(a -> a[1])); // sort by end element of every balloon. cant use subtraction here to avoid overflow
